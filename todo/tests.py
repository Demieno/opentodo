...
class TestViews(TestCase):
    ...
    def urltest(self, url, status_code):
        ...
        self.assertEquals(rs.status_code, status_code,
                          '%s returned %s, %s was expected' % (url, rs.status_code, status_code))
    ...
    def test_add_task(self):
        ...
        # ���������� ������ (������� 302 - �������� �� �������� ������)
        rs = self.c.post(reverse('add_task'),
                         {'project': '1', 'title': 'New task', 'assigned_to': '1', 'deadline': '2008-12-12'})
        self.assertEquals(rs.status_code, 302)

        # ���������� ������, ������������� - ������������ ��� email (������� 302 - �������� �� �������� ������)
        rs = self.c.post(reverse('add_task'),
                         {'project': '1', 'title': 'One more', 'assigned_to': '2', 'deadline': '2008-12-12'})
        self.assertEquals(rs.status_code, 302)

...
class Project(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, null=True, db_column='author', related_name="projects",
                               verbose_name="Автор")
...
class Task(models.Model):
    ...
    author = models.ForeignKey(User, on_delete=models.CASCADE, null=True, db_column='author', related_name="tasks",
                               verbose_name="Автор")
    assigned_to = models.ForeignKey(User, on_delete=models.CASCADE, null=True, db_column='assigned_to',
